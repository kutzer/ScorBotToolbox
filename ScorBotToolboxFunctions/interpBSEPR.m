function q = interpBSEPR(scorSim,q_f,coefs)
...
%           q_o - 5-element array containing joint positions
%           q_f - 5-element array containing joint positions
...
for i = 1:numel(q_o)
    ...
    q_dwell(i,:) = repmat(q_0(i),size(tt_dwell));
